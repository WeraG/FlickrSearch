//
//  FlickrPhotosViewCell.swift
//  FlickrSearch
//
//  Created by Weronika Golota on 08.12.2017.
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        flickr.searchFlickrForTerm(textField.text!) {
            ...
            if let error = error {
                ...
                let actionSheetController: UIAlertController = UIAlertController(title: "Search error", message: "Seems that an error occured during fetching photos!", preferredStyle: .alert)
